...
while start:
    ...
    pygame.draw.rect(window, (144,238,144), (280,50,640,70), border_top_left_radius=100, border_top_right_radius=100)
    pygame.draw.rect(window, (144,238,144), (280,550,640,70), border_bottom_left_radius=100, border_bottom_right_radius=100)
